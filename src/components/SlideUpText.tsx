type SlideUpTextProps = { text: string, className?: string };

export default function SlideUpText({ text, className="" }: SlideUpTextProps) {
    return (
        <span className={`text-giant block font-bebas leading-[1] whitespace-nowrap relative group/heading ${className}`}>
            <span
                data-content={text}
